<div role="tabpanel" class="tab-pane" id="repay">

 <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="navbar-form">
   <table class="form_group">
     <tr  class="has-warning">
         <td><label for="fullname">שם פרטי ומשפחה</label></td>
         <td><input type="text" class="form-control" name="fullname" id="fullname" placeholder="שם פרטי ומשפחה - חובה!"></td>
     </tr>
     ...
     <tr class="no_spin has-warning">
         <td><label for="repayment">סכום התשלום</label></td>
         <td><input type="number" name="TotalDeposit" id="TotalDeposit" class="form-control" placeholder="סכום - שדה חובה!" required oninvalid="this.setCustomValidity('שדה חובה')" oninput="setCustomValidity('')"></td>
     </tr>
     ...
     <tr>
         <td><label for="DateOfRepayment">תאריך</label></td>
         <td><input type="text" name="DateOfDeposit" id="repay_datepicker" class="form-control datepicker"></td>
     </tr>
     <td></td>
       <td>
